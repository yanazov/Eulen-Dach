...
function js_menu_click(current_this, number){
	for(i=0; i<7; i++ )	{
		...
		document.getElementsByClassName("menu_inner_li")[i].style.color = "#fff";
		document.getElementsByClassName("menu_inner_li")[i].style.background = "#a5a5a5";
	...
	current_this.style.color = "#6a4d1e";
	...
	$('.main_content').jScrollPane({showArrows:true, scrollbarWidth:19, dragMaxHeight:43});
